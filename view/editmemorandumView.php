  ...
  <div class="col-xs-12 col-md-6">
    ...
    <div class="col-xs-12 col-md-12"> 
      <div class="form-group">
        ...
        <input type="nroanexos" name="nroanexos" value="<?php echo $documento->nroanexos ?>" class="form-control" id="nroanexos" placeholder="nroanexos">
      </div>
      <div class="form-group">
        <label for="anexos">Anexos:</label>
        <input type="text" name="anexos" value="<?php echo $documento->anexos ?>" class="form-control" id="anexos" placeholder="Introduce anexos">
      </div>
    </div>
  <div class="row">
    <div class="col-xs-12">
